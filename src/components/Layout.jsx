...
import {
  ...
  BarChart3, LogOut, Menu, X, Leaf, UtensilsCrossed, CreditCard, Shield, Package, ShoppingBag,
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/boutiques',   label: 'Boutiques',   icon: ShoppingBag,     permission: 'boutiques' },
